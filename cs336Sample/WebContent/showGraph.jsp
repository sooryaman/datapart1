	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		while (result.next()) { 
   			...
   			if(graphType.equalsIgnoreCase("beersPerBar")){
   	   			map.put(result.getString("bar"),result.getInt("nbr_beers"));
   	   		}else{
